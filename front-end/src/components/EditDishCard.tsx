...
const EditDishCard = ({ cardType, closeTab, dish, categories, restaurant_id }: EditDishProps) => {
    const {
        register,
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="mt-14 text-3xl text-center ">{cardType === CardType.Create ? "Create Dish" : "Edit Dish"}</p>
